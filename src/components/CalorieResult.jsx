    ...
    <div className="result-container">
      ...
      <div className="result-content">
            ...
            <div className="calorie-circle">
              <svg viewBox="0 0 120 120" className="calorie-svg">
                ...
                <circle 
                  ...
                  style={{
                    strokeDasharray: `${(result.calories / 2500) * 339} 339`
                  }}
                />
              </svg>
        ...
        {result.nutritionSources?.length > 0 && (
          <div className="nutrition-sources-info">
            <h3>🔍 Nutrition Data Sources</h3>
            <p className="sources-intro">Cross-referenced from:</p>
            <div className="nutrition-sources">
              {result.nutritionSources.map((source, index) => (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className={`source-link ${source.reliability}`}
                >
                  <div className="source-content">
                    <span className="source-name">{source.source}</span>
                    <span className={`reliability-badge ${source.reliability}`}>
                      {source.reliability === 'high' ? '✓ High' : source.reliability === 'medium' ? '◐ Medium' : '○ Low'} Reliability
                    </span>
                  </div>
